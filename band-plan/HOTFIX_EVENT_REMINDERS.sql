-- HOTFIX: Solución rápida para el error de event_reminders
...
DROP POLICY IF EXISTS "Group members can access event reminders" ON public.event_reminders;

-- Crear política simple que permite acceso a miembros del grupo
