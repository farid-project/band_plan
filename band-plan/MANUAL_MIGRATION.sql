-- Manual migration to add member types to group_members table
-- Execute this in your Supabase SQL Editor

-- 1. Add the member_type column
...
-- 3. Update existing members to be 'registered' type
...
-- 5. Create the flexible function for adding members
